<?php
    ...
    $round48 = $Create->getCutoffRoundYr4($category,$year,$seatpool,$collegeId, 8);
    $round49 = $Create->getCutoffRoundYr4($category,$year,$seatpool,$collegeId, 9);
    ...
    $round58 = $Create->getCutoffRoundYr5($category,$year,$seatpool,$collegeId, 8);
    $round59 = $Create->getCutoffRoundYr5($category,$year,$seatpool,$collegeId, 9);
    echo $round41 . "," . $round42 . "," . $round43 . "," . $round44 . "," . $round45 . "," . $round46  . "," . $round47  . "," . $round48 . "," . $round49 . "," .  $round51 . "," . $round52 . "," . $round53 . "," . $round54 . "," . $round55 . "," . $round56 . "," .  $round57 . "," .  $round58 . "," .  $round59; 
?>
