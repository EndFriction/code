...
// ===================== College Details Function ===============================================================
       ...
       public function getCollegeBannerDetails($collegeId) {
              $query= $this->pdo->prepare("SELECT * FROM  nit_college  WHERE collegeId = ?");
       ...
       public function getCollegeHighlightDetails($collegeId) {
              ...
              $query= $this->pdo->prepare("SELECT highlights FROM  nit_college WHERE collegeId = ?");
              $query->bindvalue(":collegeId", $collegeId);
              $query->execute(array($collegeId));
              $row=$query->fetch(PDO::FETCH_ASSOC);
       ...
       {
              $query= $this->pdo->prepare("SELECT * FROM nit_nirf_rank WHERE collegeId = ?");
              $query->bindvalue(":collegeId", $collegeId);
              $query->execute(array($collegeId));
 ...
 // ================================================== College Cut-off  ============================= =============================
       ...
       {
              $query=$this->pdo->prepare("SELECT * FROM  nit_cutoff  WHERE branch LIKE  '%4%'  AND round = ? AND category = ? AND year = ? AND Gender = ?  AND  collegeId = ? ORDER BY Quota , branch");
       ...
       {
              $query=$this->pdo->prepare("SELECT * FROM  nit_cutoff WHERE branch LIKE '%5%' AND round = ? AND category = ? AND year = ? AND Gender = ?  AND  collegeId = ? ORDER BY Quota , branch");
              $query->bindvalue(":category",$category);
              $query->bindvalue(":year",$year);
              $query->bindvalue(":Gender",$Gender);
              $query->bindvalue(":collegeId",$collegid);
       ...
       public function getcutoffrow($row) {
              ...
              $quota=$cutoff->getquota();

              return  "<tr><td>$quota</td> <td>$branch</td> <td>$openrank</td><td>$closerank</td> </tr>";
       ...
       public function getAlumniNameJson($collegeId) {
              $query= $this->pdo->prepare('SELECT alumniName FROM  nit_alumni WHERE collegeId = ?');
              $query->bindvalue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
       ...
       public function getAlumniBranchNameJson($collegeId) {
              $query= $this->pdo->prepare('SELECT alumniBranchName FROM  nit_alumni WHERE collegeId = ?');
              $query->bindvalue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
       ...
       public function getAlumniPassingYearJson($collegeId) {
              $query= $this->pdo->prepare('SELECT alumniPassingYear FROM  nit_alumni WHERE collegeId = ?');
              $query->bindvalue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
       ...
       public function getAlumniImageJson($collegeId) {
              $query= $this->pdo->prepare('SELECT alumniImage FROM  nit_alumni WHERE collegeId = ?');
              $query->bindvalue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
       ...
       public function getAlumniAchievementJson($collegeId) {
              $query= $this->pdo->prepare('SELECT alumniAchievement FROM  nit_alumni WHERE collegeId = ?');
              $query->bindvalue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
       ...
       public function getCompanyNameJson() {
              ...
              $query= $this->pdo->prepare("SELECT companyName FROM  nit_top_company ORDER BY RAND() ");
              $query->execute();
       ...
       public function getCompanyLogoJson() {
              ...
              $query= $this->pdo->prepare("SELECT companyLogo FROM  nit_top_company  ORDER BY RAND()");
              $query->execute();
       ...
       // ===================== Placement  =============================
       public function getPlacementJson($placementYear) {

              $query= $this->pdo->prepare("SELECT * FROM  nit_placement WHERE placementYear = ? ");

              $query->bindvalue(":placementYear", $placementYear);
              $query->execute(array($placementYear));
       ...
       public function getFeeA5Json() {
              ...
              $query= $this->pdo->prepare("SELECT genewsobcA5 FROM  nit_fee ");
              $query->execute();
       ...
       public function getFeeA1LT5Json() {
              ...
              $query= $this->pdo->prepare("SELECT genewsobcA1LT5 FROM  nit_fee ");
              $query->execute();
       ...
       public function getFeeLT1Json() {
              ...
              $query= $this->pdo->prepare("SELECT genewsobcLT1 FROM  nit_fee ");
              $query->execute();
       ...
       public function getFeeMinorityJson() {
              ...
              $query= $this->pdo->prepare("SELECT scstpwd FROM  nit_fee");
              $query->execute();
       ...
       public function getFeeParticularNameJson() {
              ...
              $query= $this->pdo->prepare("SELECT feeParticularName FROM  nit_fee");
              $query->execute();
       ...
       public function get4YearCourse($collegeId) {
              $query= $this->pdo->prepare("SELECT DISTINCT branch FROM `nit_cutoff` WHERE branch LIKE '%4%' AND collegeId = ?");
              $query->bindvalue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
       ...
       public function get5YearCourse($collegeId) {
              $query= $this->pdo->prepare("SELECT DISTINCT branch FROM `nit_cutoff` WHERE branch LIKE '%5%' AND collegeId = ?");
              $query->bindvalue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
 ...
 // ===================== Fest an Events ===============================================================
       ...
       public function getFestDetails() {
              ...
              $query= $this->pdo->prepare("SELECT * FROM  nit_fest");
              $query->execute();
       ...
       public function getFestVideoDetails($collegeId) {
              ...
              $query= $this->pdo->prepare("SELECT * FROM nit_fest WHERE collegeId = ?");
              $query->bindValue(":collegeId",$collegeId);
              $query->execute(array($collegeId));
